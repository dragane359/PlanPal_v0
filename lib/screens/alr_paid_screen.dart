...
class AlrPaidScreen extends StatefulWidget {
  const AlrPaidScreen({Key? key, required User user})
      : _user = user,
        super(key: key);
  final User _user;
  @override
  _AlrPaidScreenState createState() => new _AlrPaidScreenState();
}

class _AlrPaidScreenState extends State<AlrPaidScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final amount = TextFormField(
      ...
      decoration: InputDecoration(
        hintText: 'Amount you have paid them',
        contentPadding: EdgeInsets.fromLTRB(20.0, 10.0, 20.0, 10.0),
        border: OutlineInputBorder(borderRadius: BorderRadius.circular(32.0)),
      ),
      textInputAction: TextInputAction.next,
